...
//                console.info(e)
	...
	_touchmove : function (e) {
        ...
        // 第一页禁止向下滑
        if(this.index==0){
            if ((this.opts.isVertical ? (this._touchstartY - e.touches[0].pageY < 0) : (this._touchstartX - e.touches[0].pageX < 0)) ) {
                return ;
            }
        }
        ...
        // 最后页禁止向上滑
        if(this.index == (this.length -1)){
            if ((this.opts.isVertical ? (e.touches[0].pageY - this._touchstartY < 0) : (e.touches[0].pageX - this._touchstartX < 0)) ) {
                return ;
            }
        }
